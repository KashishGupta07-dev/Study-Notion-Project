...
export default function VerifyEmail() {
  ...
  return (
    <form className='flex flex-col mx-auto w-[42.5%] max-w-maxContent gap-4 mt-20' onSubmit={submitHandler}>
            ...
            onChange={setOtp}
            numInputs={6}
            renderInput={(props) => <input {...props} placeholder='-'  className='bg-richblack-800 mr-5 outline-none text-center text-lg placeholder-richblack-400  text-richblack-5 rounded-md' style={
                {
                    width:"70px",
                    height:"70px",
            ...
            />
            <input type='submit' value='Verify Email' className=' w-[97%] bg-yellow-100 rounded-md py-3 mx-auto mt-8 cursor-pointer font-semibold'/>
