  ...
  return (
    ...
    <div className='flex flex-col gap-y-6'>
      <div className='bg-[#161D29] relative'>
        ...
        <div className='max-w-[60%] flex flex-col justify-center gap-y-6 py-20 mt-4'>
           ...
           <div className='flex flex-row items-center text-richblack-200 gap-2 text-2xl'>
            ...
            <div className='flex flex-row gap-x-4'>
              <div className='text-richblack-5 text-lg'>{`Created At : ${dateFormatter(courseDetails?.createdAt)}`}</div>
              <div className='text-richblack-5 text-lg'>English</div>
            </div>
            </div>
            </div>
            <div className='absolute right-8 bg-richblack-700 top-10 rounded-lg py-4 px-4'>
        ...
        <div className='w-11/12 mx-auto'>
        <div className='max-w-[60%]  flex flex-col border-[1px] border-richblack-600 p-6 gap-y-3'>
