        ...
        <tbody>
          {
            courses && courses.length>0 ? courses.map((course)=>(
              <tr key={course._id} className='border-[0.5px] border-richblack-800 border-collapse'>
                <td className='flex flex-row my-5 ml-5 '>
                  ...
                  <div className='flex flex-col justify-between h-[148px]'>
                    ...
                    <div className='text-sm text-richblack-200 text-start font-light'>{course?.courseDescription}</div>
                ...
                <td className='text-richblack-100 font-medium'>2 hr 30 min</td>
